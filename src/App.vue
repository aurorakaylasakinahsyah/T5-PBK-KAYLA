<template>
  <q-layout view="hHh lpR fFf">
    <q-header elevated class="bg-deep-pink text-white" height-hint="98">
      <q-toolbar>
        <q-btn dense flat round icon="menu" @click="toggleLeftDrawer" />
        <q-toolbar-title>
          <q-avatar>
            <img src="https://img.freepik.com/vetores-premium/elementos-cosmeticos-adesivos-menina-maquiagem-ilustracao-dos-desenhos-animados_484020-48.jpg?w=2000">
          </q-avatar>
          BEAUTY BAR
        </q-toolbar-title>
      </q-toolbar>
